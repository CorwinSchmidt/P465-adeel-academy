...
import 'package:learning_management_system/widgets/dashboard/dash_course.dart';
...
class StartingDashView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Course testing:
    Course course1 = Course("1", "Biology 1", "Welcome to Biology 1, this is our course description....", ["st1"], ["te1"], null);
    Course course2 = Course("2", "Physics 2", "Welcome to Physics 2, where we learn about physics 2", ["st2"], ["te2"], null);
    Course course3 = Course("3", "Physics 3", "Welcome to Physics 3, where we learn about physics 3", ["st3"], ["te3"], null);
